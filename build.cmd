...
echo "linux-x86_64-glibc (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:linux-x86_64-glibc
echo "linux-aarch64-glibc (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:linux-aarch64-glibc
echo "macos-x86_64 (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:macos-x86_64
echo "macos-aarch64 (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:macos-aarch64
echo "windows-x86_64 (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:windows-x86_64
echo "windows-aarch64 (cc)" && call bazelisk.exe build //cc/... --platforms=//build/native/platforms:windows-aarch64
